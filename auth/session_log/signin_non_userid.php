<?php session_start();include "../../config/koneksi.php"; error_reporting(0);
...
<body>
<form id="login-form" action="<?php echo $site;?>backend/proses_sign_nonuser.php" method="post" enctype="multipartformdata">
	...
	<div class="content clearfix">
		...
		<div class="box sign-card clearfix">
			<input type="hidden" name="checkin" value="<?php echo $_SESSION['session_checkin'];?>">
			<input type="hidden" name="checkout" value="<?php echo $_SESSION['session_checkout'];?>">
			<input type="hidden" name="jumlah_orang" value="<?php echo $_SESSION['session_jumlah_orang'];?>">
			<input type="hidden" name="jumlah_kamar" value="<?php echo $_SESSION['session_jumlah_kamar'];?>">
