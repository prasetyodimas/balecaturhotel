...
if (empty($_POST['checkin']) AND empty($_POST['checkout'])) {
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							Pencarian Kamar Telah ditemukan untuk <?php echo $_SESSION['session_jumlah_orang'];?> Orang & <?php echo $_SESSION['session_jumlah_kamar']." Kamar";?>
						</div>
							...
							<div class="panel panel-default container-description">
								...
								<div class="panel-body">
									<div class="container-description">
										...
										<div class="row">
											<div class="col-lg-12">
												<a class="btn btn-block btn-custom-fields" href="backend/proses_tambah_kamar.php?act=adding_other_room&id=<?php echo $data['id_kategori_kamar'];?>">BOOKING NOW</a>
											</div>
										</div>
									</div>
								</div>
