...
<script type="text/javascript">
   ...
   <div class="col-lg-12">
      <div class="font-sizerheading">
         <h1 class="page-header">Reservasi Online / Manajemen Konfirmasi Pesan</h1>
      </div>
      <form action="<?php echo $site;?>adminbase/backend/proses_konfirmasi_pesan.php?act=update_konfirmasi_pesan&id=<?php echo $_GET['id']?>" method="post" enctype="multipart/form-data">
         ...
         <div class="table-responsive">
            <table class="table table-hover">
               ...
               <?php 
                  ...
                  $x         = $result_room['id_kategori_kamar'];
                  $getdiskon = mysqli_fetch_array(mysqli_query($konek,"SELECT * FROM diskon WHERE id_kategori_kamar='$result_room[id_kategori_kamar]'"));
                  ...
                  //variable percent 10%
                  $percent = (($result_room['tarif']*10)/100); 
                  //variable discount
                  $discount =(($result_room['tarif']*$available_disc)/100);
               ?>
               <tbody>
                  <tr>
                     ...
                     <td>Rp.<?php echo formatuang($result_room['tarif']+$percent-$discount);?></td>
                     <td>Rp.<?php echo formatuang(($result_room['tarif']+$percent-$discount)*$jumlah_hari);?></td>
                  </tr>
               </tbody>
               <?php } ?>
            </table>
         ...
         <section data-title="Layanan-tambahan">
            ...
            <div class="panel panel-default">
               ...
               <?php }elseif ($databooking['layanan_extra']=='Ya') { ?>
                  ...
                  <?php $gettransaksi_extra = mysqli_fetch_array(mysqli_query($konek,
                                              "SELECT tl.kd_booking, 
                                                      tl.id_rental, 
                                                      r.kate_kendaraan, 
                                                      r.nama_kendaraan, 
                                                      r.harga_kendaraan, 
                                                ...
                                                JOIN detail_booking_rental dbr ON tl.id_rental=dbr.id_rental
                  ...
                  <?php if ($get_trans_other['id_extrabed']!=0){?>
                     <?php $gettransaksi_extra = mysqli_fetch_array(mysqli_query($konek,
                                                "SELECT tl.kd_booking, 
                                                 ...
                                                 JOIN extrabed e ON tl.id_extrabed=e.id_extrabed 
                                                 WHERE tl.kd_booking='$_GET[id]'")); ?>
                     <div style="margin-top:50px">
                        ...
                        <div class="form-group">
                           <p>Harga Extrabed<span class='other-transac-harga-extrabed'>: Rp.<?php echo formatuang($gettransaksi_extra['harga_extrabed']);?></span></p>
                        </div>
                     </div>
         ...
         <div class="form-group">
            <button class="btn btn-warning" onclick="javascript:history.back(-1);">Kembali</button>
         </div>
      </form>
